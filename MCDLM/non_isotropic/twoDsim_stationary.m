...
sigma1 = discrete_covariance_ellipsoid([stddev_fwhm1 stddev_fwhm2], 2);
niter = 1e5;

if min(rho_disc1, rho_disc2) == 0.01
    n_lim = 1e6;
elseif min(rho_disc1, rho_disc2) == 0.5
    n_lim = 1e6;
elseif min(rho_disc1, rho_disc2) == 0.99
    n_lim = 2e5;
end
...
%% Isotropic case: combining plots together
load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_200.mat'));
% locmaxZ3 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_1000.mat'));
% locmaxZ3 = locmaxZ3.locmaxZ;
% locmaxZ4 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_10000.mat'));
% locmaxZ4 = locmaxZ4.locmaxZ;
locmaxZ5 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_20.mat'));
locmaxZ5 = locmaxZ5.locmaxZ;
locmaxZ6 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_50.mat'));
locmaxZ6 = locmaxZ6.locmaxZ;
locmaxZ7 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_100.mat'));
...
lgd.FontSize = 10;
title({['$\rho_1$ = $\rho_2$ = ' num2str(rho_disc1) '\ (' 'FWHM = ' num2str(round(FWHM_1,1)) ')']},...
    'Interpreter','latex')
ax = gca;

axis square

%saveas(gcf, '2D_rho1_0.99_rho2_0.99.jpg')

%% Stationary (non-isotropic) case
load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_200.mat'));
% locmaxZ3 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_1000.mat'));
% locmaxZ3 = locmaxZ3.locmaxZ;
% locmaxZ4 = load(strcat('2D_rho1_',num2str(rho_disc1),'_rho2_',num2str(rho_disc2),'_nsim_10000.mat'));
...
%saveas(gcf, '2D_rho1_0.5_rho2_0.99_nsim_1000.jpg')